...
<body class="w100">
	...
	<div id="app">
		<!--banner图-->
		<div class="banner"
			style="background-image: url('<c:url value="/static/img/banner-${subjectId}.jpg" />')"></div>
		...
		<div class="classify">
			...
			<c:forEach items="${subject.courseSet }" var="course">
				<div class="section">
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='/video-ssh/front/video/index.action?videoId='+id+'&subjectId='+subjectId;
		}
	</script>
