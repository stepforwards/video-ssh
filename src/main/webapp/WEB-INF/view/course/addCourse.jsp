...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="<c:url value="/course/doAddCourse.action"/>" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="courseName" class="form-control" id="inputVideoTime" placeholder="课程标题">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">简介</label>
				<div class="col-sm-10">
					<textarea class="form-control" name="courseDescr" rows="3" style="resize: none;"></textarea>
